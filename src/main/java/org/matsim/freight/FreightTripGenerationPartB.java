...
public class FreightTripGenerationPartB {
	// In this part, the freight traffic will be generated by creating dummy freight
	// person.
	// For each frieght trip, random links inside the departure region and the
	// arrival region
	// will be set as the origin and destination of the freight trip (becasue we
	// don't have
	// further data on the exact location of the origin/destination freight trip)

	// INPUT: the file generated by Part A ; Output path
	private static final String SHAPEFILE_PATH = "https://svn.vsp.tu-berlin.de/repos/public-svn/matsim/scenarios"
			+ "/countries/de/duesseldorf/duesseldorf-v1.0/input/shapeFiles/freight/NUTS3_2010_DE.shp";
	private static final String NETWORK_FILE = "C:\\Users\\cluac\\MATSimScenarios\\Freight-Germany\\"
			+ "german-primary-road.network.xml.gz";
	...
	private static final double AVERAGE_CAPACITY_OF_TRUCK = 16 * 365 * 100;
	...
	public static void main(String[] args) throws IOException {
		if (args.length == 0) {
			args = new String[] {
					"C:\\Users\\cluac\\MATSimScenarios\\Freight-Germany\\NUTS-Verkehrszellen-Table-Germany.csv",
					"C:\\Users\\cluac\\MATSimScenarios\\Dusseldorf\\freight\\1pct-german-long-distance-freight.xml" };
		}
