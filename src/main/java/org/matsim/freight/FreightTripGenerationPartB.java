...
public class FreightTripGenerationPartB {
	...
	public static void main(String[] args) throws IOException {
		if (args.length == 0) {
			args = new String[] {
					"C:\\Users\\cluac\\MATSimScenarios\\Dusseldorf\\freight\\RegionID-RegionName-Table.csv",
					"C:\\Users\\cluac\\MATSimScenarios\\Dusseldorf\\freight\\10pct-freight-only-plans.xml" };
		}
